const URL_API = "https://backend-render-unjy.onrender.com/materia/"
...
const MENSAGEM_ERRO = "Não foi possível carregar as matérias!"
...
function realizarExclusao(id){
    ...
    .then(function(response){
        if (response.status === 204) {
            ...
            alert("Não foi possível deletar a matéria!")
        }
...
function salvarLocalStorage(obj){
    ...
    localStorage.setItem('cargaHoraria', obj.cargaHoraria)
    localStorage.setItem('professorId', obj.professorId)
}